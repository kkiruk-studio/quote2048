...
LOCALES = {
    "en": {
        ...
        "desc": "The 2048 you know, but sentences grow instead of numbers. Merge matching quote tiles up 46 themes and 506 verified quotes — from a humble proverb to a crown quote — set against public-domain masterpieces.",
        ...
        "cnt_kicker": "WHAT'S INSIDE", "cnt_num": "46 · 506",
        ...
        "provs": [
            ...
            ["22", "Author collections", "Shakespeare, Nietzsche, Tolstoy, Confucius, Woolf — a Pro shelf."],
            ["506", "Verified quotes", "From real works, in five languages, with originals in Latin, German, Classical Chinese."],
            ["46", "Masterpieces", "Monet, van Gogh, Klimt, Hokusai — one painting behind every theme."],
        ],
        "shots_kicker": "SCREENS", "shots_num": "IOS",
        "shots_h2": "A gallery you play <em>one tile at a time</em>.",
        "shots_caps": ["A quiet board", "46 painted themes", "Sentences, not numbers"],
        ...
        "feats": [
            ...
            ["Offline, no login", "Everything is bundled. No account, no server. Rewarded ads are always your choice."],
    ...
    "ko": {
        ...
        "desc": "알던 2048, 그런데 숫자가 아니라 문장이 자랍니다. 같은 명언 타일을 합쳐 46개 테마·506개의 검증된 명언을 속담에서 왕관 명언까지 키우세요. 배경은 퍼블릭 도메인 명화.",
        ...
        "cnt_kicker": "무엇이 담겼나", "cnt_num": "46 · 506",
        "cnt_h2": "진짜 명언. <em>진짜 그림.</em>",
        "cnt_lede": "지어낸 것 없이 — 모든 문장은 출처를 대조했고, 모든 배경은 퍼블릭 도메인 명화입니다.",
        "provs": [
            ["24", "주제 테마", "시작·평온·용기·행복 등 — 전부 무료."],
            ["22", "작가 컬렉션", "셰익스피어·니체·톨스토이·공자·울프 — Pro의 소장 서가."],
            ["506", "검증된 명언", "실제 저작에서, 5개 언어로, 라틴어·독일어·한문 원어까지."],
            ["46", "명화 배경", "모네·고흐·클림트·호쿠사이 — 테마마다 그림 한 점."],
        ],
        "shots_kicker": "화면", "shots_num": "IOS",
        "shots_h2": "한 타일씩 플레이하는 <em>작은 갤러리</em>.",
        "shots_caps": ["조용한 보드", "명화로 채운 46 테마", "숫자가 아니라 문장"],
        ...
        "feats": [
            ...
            ["오프라인·로그인 없음", "모든 콘텐츠 내장. 계정도 서버도 없습니다. 리워드 광고는 늘 선택입니다."],
    ...
    "ja": {
        ...
        "desc": "知っている2048、でも数字ではなくことばが育ちます。同じ名言タイルを合わせ、46テーマ・506の検証済み名言を、ことわざから頂点の名言まで育てましょう。背景はパブリックドメインの名画。",
        ...
        "cnt_kicker": "中身", "cnt_num": "46 · 506",
        "cnt_h2": "本物の名言。<em>本物の絵画。</em>",
        "cnt_lede": "捏造なし — すべての文は出典を照合し、すべての背景はパブリックドメインの名画です。",
        "provs": [
            ["24", "主題テーマ", "はじまり・平穏・勇気・幸福など — すべて無料。"],
            ["22", "作家コレクション", "シェイクスピア・ニーチェ・トルストイ・孔子・ウルフ — Proの書架。"],
            ["506", "検証済み名言", "実際の著作から、5言語で、ラテン語・ドイツ語・漢文の原文も。"],
            ["46", "名画の背景", "モネ・ゴッホ・クリムト・北斎 — テーマごとに一枚。"],
        ],
        "shots_kicker": "画面", "shots_num": "IOS",
        "shots_h2": "一タイルずつ遊ぶ<em>小さな美術館</em>。",
        "shots_caps": ["静かな盤面", "名画の46テーマ", "数字ではなく、ことば"],
        "feat_kicker": "細部", "feat_num": "06",
        ...
        "feats": [
            ...
            ["オフライン・ログイン不要", "すべて内蔵。アカウントもサーバーもなし。広告は常に任意です。"],
    ...
    "zh-hans": {
        ...
        "desc": "你熟悉的2048，只是数字换成会成长的句子。合并相同的名言方块，把46个主题·506句经核实的名言从谚语一路养到巅峰名言，背景是公共领域名画。",
        ...
        "cnt_kicker": "内含", "cnt_num": "46 · 506",
        "cnt_h2": "真实的名言。<em>真实的画作。</em>",
        "cnt_lede": "绝不杜撰 — 每句都核对出处，每幅背景都是公共领域名画。",
        "provs": [
            ["24", "主题合集", "开始·平静·勇气·幸福等 — 全部免费。"],
            ["22", "作家合集", "莎士比亚·尼采·托尔斯泰·孔子·伍尔夫 — Pro 藏书架。"],
            ["506", "核实的名言", "取自原著，五种语言，附拉丁语·德语·文言文原文。"],
            ["46", "名画背景", "莫奈·梵高·克里姆特·葛饰北斋 — 每个主题一幅。"],
        ],
        "shots_kicker": "界面", "shots_num": "IOS",
        "shots_h2": "一格一格玩的<em>小美术馆</em>。",
        "shots_caps": ["安静的棋盘", "46幅名画主题", "不是数字，是句子"],
        ...
        "feats": [
            ...
            ["离线·无需登录", "内容全部内置，没有账号也没有服务器。广告始终由你选择。"],
    ...
    "zh-hant": {
        ...
        "desc": "你熟悉的2048，只是數字換成會成長的句子。合併相同的名言方塊，把46個主題·506句經核實的名言從諺語一路養到巔峰名言，背景是公有領域名畫。",
        ...
        "cnt_kicker": "內含", "cnt_num": "46 · 506",
        "cnt_h2": "真實的名言。<em>真實的畫作。</em>",
        "cnt_lede": "絕不杜撰 — 每句都核對出處，每幅背景都是公有領域名畫。",
        "provs": [
            ["24", "主題合集", "開始·平靜·勇氣·幸福等 — 全部免費。"],
            ["22", "作家合集", "莎士比亞·尼采·托爾斯泰·孔子·吳爾芙 — Pro 藏書架。"],
            ["506", "核實的名言", "取自原著，五種語言，附拉丁語·德語·文言文原文。"],
            ["46", "名畫背景", "莫內·梵谷·克林姆·葛飾北齋 — 每個主題一幅。"],
        ],
        "shots_kicker": "介面", "shots_num": "IOS",
        "shots_h2": "一格一格玩的<em>小美術館</em>。",
        "shots_caps": ["安靜的棋盤", "46幅名畫主題", "不是數字，是句子"],
        ...
        "feats": [
            ...
            ["離線·免登入", "內容全部內建，沒有帳號也沒有伺服器。廣告始終由你選擇。"],
