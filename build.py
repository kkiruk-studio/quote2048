...
L = {
 "en": dict(dir="", lang="en",
    ...
    sub="Merge two matching lines — a greater quote takes their place.<br>Reach 2048 to meet the crown quote.",
    tease="And 2048 isn't the end.",
    ...
    crown_meta="— Laozi · the crown of “Beginnings”",
 ...
 "ko": dict(dir="ko/", lang="ko",
    ...
    sub="같은 문장 두 개를 합치면, 한 단계 위의 명언이 나타납니다.<br>2048에서 왕관 명언을 만나세요.",
    tease="그리고, 2048이 끝이 아닙니다.",
    soon="곧 출시 · iOS",
    tile_a="시작이<br>반이다", tile_b="시작이<br>반이다",
    tile_m="늦은 때는<br>없다",
    crown="큰 나무도 작은 싹에서<br>자란다",
    crown_meta="— 노자 · 「시작」의 왕관 명언",
 ...
 "ja": dict(dir="ja/", lang="ja",
    ...
    sub="同じ文をふたつ合わせると、ひとつ上の名言が現れます。<br>2048で、王冠の名言に出会えます。",
    tease="そして、2048で終わりではありません。",
    soon="近日公開 · iOS",
    tile_a="始まりは<br>半分の成功", tile_b="始まりは<br>半分の成功",
    tile_m="遅すぎることは<br>ない",
    crown="合抱の木も<br>毫末より生ず",
    crown_meta="— 老子 · 「始まり」の王冠",
 ...
 "zh-hans": dict(dir="zh-hans/", lang="zh-Hans",
    ...
    sub="合并两句相同的话，出现更高一级的名言。<br>抵达2048，遇见王冠名言。",
    tease="而且，2048并不是终点。",
    soon="即将上线 · iOS",
    tile_a="好的开始<br>是成功的一半", tile_b="好的开始<br>是成功的一半",
    tile_m="一切都<br>不算晚",
    crown="合抱之木<br>生于毫末",
    crown_meta="— 老子 · 「开始」的王冠",
 ...
 "zh-hant": dict(dir="zh-hant/", lang="zh-Hant",
    ...
    h1="用名言玩的<br><em>2048。</em>",
    sub="合併兩句相同的話，出現更高一級的名言。<br>抵達2048，遇見王冠名言。",
    tease="而且，2048並不是終點。",
    soon="即將上線 · iOS",
    tile_a="好的開始<br>是成功的一半", tile_b="好的開始<br>是成功的一半",
    tile_m="一切都<br>不算晚",
    crown="合抱之木<br>生於毫末",
    crown_meta="— 老子 · 「開始」的王冠",
